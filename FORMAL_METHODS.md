...
**Total: 122 Kani BMC harnesses repo-wide** (portcullis 70, portcullis-core 26,
ck-kernel 17, nucleus-ifc-kernel 6, nucleus-econ-kernels 1, nucleus-permission-market 2; recount with
`scripts/formal-numbers.sh --print` — a bare `grep -rc` says 126 because it also
...
|-----------|----------|----------|
| **Permission lattice** (portcullis) | Verified | ~165K LOC, 66 Kani BMC proofs in the `portcullis` crate (122 repo-wide), Lean 4 lattice/IFC proofs, proptest conformance suite. (Verus removed — see note below.) |
...
| **Kani** | Bounded model checking | 122 harnesses repo-wide (portcullis 70, portcullis-core 26, ck-kernel 17, nucleus-ifc-kernel 6, nucleus-econ-kernels 1, nucleus-permission-market 2) | DecisionToken linearity, lattice distributivity, exposure monoid, constitutional kernel invariants |

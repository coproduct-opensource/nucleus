...
| Metric | Count | Where |
|---|---|---|
| Kani BMC harnesses | 122 | portcullis 70, portcullis-core 26, ck-kernel 17, nucleus-ifc-kernel 6, nucleus-econ-kernels 1, nucleus-permission-market 2 (`scripts/formal-numbers.sh`) |

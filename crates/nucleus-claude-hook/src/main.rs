...
// CLI subcommand handlers live in commands.rs
use commands::{run_doctor, run_help, run_init, run_smoke_test, show_profile};
...
mod tests {
    ...
    // Setup format tests moved to setup.rs (#874)

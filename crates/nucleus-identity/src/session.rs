...
//! // spiffe://nucleus.local/ns/agents/sa/agent-a/session/01941234-...
//! ```
...
mod tests {
    ...
    fn test_session_identity_spiffe_uri() {
        ...
        assert!(uri.starts_with("spiffe://nucleus.local/ns/agents/sa/agent-a/session/"));
    ...
    fn test_session_identity_to_certificate_identity() {
        ...
        assert!(cert_id.service_account().starts_with("agent-a-"));
        assert!(cert_id.service_account().len() > 40); // agent-a + hyphen + UUID
    }
    ...
    fn test_session_identity_display() {
        ...
        assert!(display.starts_with("spiffe://nucleus.local/ns/agents/sa/agent-a/session/"));
    }

...
/-! # GkatCertGen2: emitted instance certificate (machine-generated; see emit_cert.py) -/

namespace GkatCertGen2
...
def eP : Exp Act Tst := (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.wh bT pA))
def fP : Exp Act Tst := (Exp.ite bT (Exp.wh bT (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.ite (BExp.not bT) (Exp.test (BExp.not bT)) pA))) (Exp.test BExp.zero))
...
def sol0 : Exp Act Tst := guardedFold [(bT, Exp.seq pA sol1)] (Exp.test BExp.zero)

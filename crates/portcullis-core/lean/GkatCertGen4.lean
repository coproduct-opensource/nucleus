...
/-! # GkatCertGen4: emitted instance certificate (machine-generated; see emit_cert.py) -/

namespace GkatCertGen4
...
def eP : Exp Act Tst := (Exp.seq (Exp.ite bT (Exp.test bT) pA) (Exp.wh (BExp.not bT) pA))
def fP : Exp Act Tst := (Exp.wh (BExp.not bT) (Exp.seq (Exp.ite bT (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)))
...
def sol0 : Exp Act Tst := guardedFold [((BExp.not bT), Exp.seq pA sol1)] (Exp.test bT)

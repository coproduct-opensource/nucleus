...
/-! # GkatCertT1: emitted Thompson-witness certificate (machine-generated; see emit_cert.py -t) -/

namespace GkatCertT1
...
def eP : Exp Act Tst := (Exp.ite (BExp.not bT) (Exp.wh (BExp.not bT) (Exp.seq (Exp.seq (Exp.ite bT (Exp.test BExp.zero) pA) (Exp.wh (BExp.not bT) pA)) (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)))) (Exp.test BExp.zero))
def fP : Exp Act Tst := (Exp.ite (BExp.not bT) (Exp.wh (BExp.not bT) (Exp.seq (Exp.seq (Exp.ite bT (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)) (Exp.ite bT (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)) (Exp.test (BExp.not bT))))) (Exp.test BExp.zero))
def gP : Exp Act Tst := (Exp.seq (Exp.seq pA (Exp.test (BExp.not bT))) (Exp.wh (BExp.not bT) (Exp.seq (Exp.wh (BExp.not bT) pA) (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)))))
...
def tmap : Sum (Option (certifiedThompson Act Tst eP).State)
  ...
  | .inl (some (Sum.inl (Sum.inl (Sum.inl (Sum.inr ()))))) => (Sum.inr (Sum.inl ()))
  | .inl (some (Sum.inl (Sum.inl (Sum.inr ())))) => (Sum.inr (Sum.inl ()))
  | .inl (some (Sum.inl (Sum.inr (Sum.inl (Sum.inr ()))))) => (Sum.inr (Sum.inr (Sum.inl (Sum.inr ()))))
  | .inl (some (Sum.inl (Sum.inr (Sum.inr (Sum.inr ()))))) => (Sum.inr (Sum.inr (Sum.inr (Sum.inr ()))))
  | .inr none => (Sum.inl (Sum.inl ()))
  | .inr (some (Sum.inl (Sum.inl (Sum.inl (Sum.inr ()))))) => (Sum.inr (Sum.inl ()))
  | .inr (some (Sum.inl (Sum.inl (Sum.inr (Sum.inr ()))))) => (Sum.inr (Sum.inl ()))
  | .inr (some (Sum.inl (Sum.inr (Sum.inl (Sum.inl (Sum.inr ())))))) => (Sum.inr (Sum.inr (Sum.inl (Sum.inr ()))))
  | .inr (some (Sum.inl (Sum.inr (Sum.inl (Sum.inr (Sum.inr ())))))) => (Sum.inr (Sum.inr (Sum.inr (Sum.inr ()))))
  | _ => START
...
theorem tstep_1_false (h : W () x = false) :
    autStep W TAut ((Sum.inr (Sum.inl ())) : gC.State) x = some ((), ((Sum.inr (Sum.inl ())) : gC.State)) := by
  rw [autStep_unit, h]; rfl
...
theorem tstep_2_false (h : W () x = false) :
    autStep W TAut ((Sum.inr (Sum.inr (Sum.inl (Sum.inr ())))) : gC.State) x = some ((), ((Sum.inr (Sum.inr (Sum.inr (Sum.inr ())))) : gC.State)) := by
  rw [autStep_unit, h]; rfl
...
theorem tstep_3_false (h : W () x = false) :
    autStep W TAut ((Sum.inr (Sum.inr (Sum.inr (Sum.inr ())))) : gC.State) x = some ((), ((Sum.inr (Sum.inl ())) : gC.State)) := by
  rw [autStep_unit, h]; rfl
theorem tstep_3_true (h : W () x = true) :
    autStep W TAut ((Sum.inr (Sum.inr (Sum.inr (Sum.inr ())))) : gC.State) x = none := by
  rw [autStep_unit, h]; rfl
...
theorem tmap_bisim : GAutBisim W SUM TAut (fun s q => tmap s = q) := by
  ...
  | Sum.inl (some (Sum.inl (Sum.inl (Sum.inl (Sum.inr ()))))) =>
      first | simp only [tmap] | skip
      refine ⟨fun a => ?_, fun a q s' hst => ?_, fun a q s2' hst => ?_⟩
      · show bval W (SUM.hlt (Sum.inl (some (Sum.inl (Sum.inl (Sum.inl (Sum.inr ()))))))) a = bval W (TAut.hlt (Sum.inr (Sum.inl ()))) a
        rw [bval_hlt_unit SUM, bval_hlt_unit TAut]
        cases hb : W () a <;> rfl
      · rw [autStep_unit] at hst
        cases hb : W () a with
        | false =>
            ...
            have hs := congrArg Prod.snd (Option.some.inj hst)
            subst hs
            exact ⟨(Sum.inr (Sum.inl ())), tstep_1_false W a hb, rfl⟩
        | true =>
            rw [hb] at hst
  ...
  | Sum.inl (some (Sum.inl (Sum.inl (Sum.inr ())))) =>
      first | simp only [tmap] | skip
      refine ⟨fun a => ?_, fun a q s' hst => ?_, fun a q s2' hst => ?_⟩
      · show bval W (SUM.hlt (Sum.inl (some (Sum.inl (Sum.inl (Sum.inr ())))))) a = bval W (TAut.hlt (Sum.inr (Sum.inl ()))) a
        rw [bval_hlt_unit SUM, bval_hlt_unit TAut]
        cases hb : W () a <;> rfl
      · rw [autStep_unit] at hst
        cases hb : W () a with
  ...
  | Sum.inl (some (Sum.inl (Sum.inr (Sum.inl (Sum.inr ()))))) =>
      first | simp only [tmap] | skip
      refine ⟨fun a => ?_, fun a q s' hst => ?_, fun a q s2' hst => ?_⟩
      · show bval W (SUM.hlt (Sum.inl (some (Sum.inl (Sum.inr (Sum.inl (Sum.inr ()))))))) a = bval W (TAut.hlt (Sum.inr (Sum.inr (Sum.inl (Sum.inr ()))))) a
        rw [bval_hlt_unit SUM, bval_hlt_unit TAut]
        cases hb : W () a <;> rfl
      · rw [autStep_unit] at hst
        cases hb : W () a with
        | false =>
            ...
            have hs := congrArg Prod.snd (Option.some.inj hst)
            subst hs
            exact ⟨(Sum.inr (Sum.inr (Sum.inr (Sum.inr ())))), tstep_2_false W a hb, rfl⟩
        | true =>
            rw [hb] at hst
      ...
      · rw [autStep_unit] at hst
        ...
        | false =>
            ...
            have hred : autStep (fun _ (_ : Unit) => false) TAut ((Sum.inr (Sum.inr (Sum.inl (Sum.inr ())))) : gC.State) ()
                = some ((), ((Sum.inr (Sum.inr (Sum.inr (Sum.inr ())))) : gC.State)) := by rfl
            rw [hred] at hst
            have hs := congrArg Prod.snd (Option.some.inj hst)
            subst hs
  ...
  | Sum.inl (some (Sum.inl (Sum.inr (Sum.inr (Sum.inr ()))))) =>
      first | simp only [tmap] | skip
      refine ⟨fun a => ?_, fun a q s' hst => ?_, fun a q s2' hst => ?_⟩
      · show bval W (SUM.hlt (Sum.inl (some (Sum.inl (Sum.inr (Sum.inr (Sum.inr ()))))))) a = bval W (TAut.hlt (Sum.inr (Sum.inr (Sum.inr (Sum.inr ()))))) a
        rw [bval_hlt_unit SUM, bval_hlt_unit TAut]
        cases hb : W () a <;> rfl
      · rw [autStep_unit] at hst
        cases hb : W () a with
        | false =>
            ...
            have hs := congrArg Prod.snd (Option.some.inj hst)
            subst hs
            exact ⟨(Sum.inr (Sum.inl ())), tstep_3_false W a hb, rfl⟩
        | true =>
            rw [hb] at hst
      ...
      · rw [autStep_unit] at hst
        ...
        | false =>
            rw [hb] at hst
            have hred : autStep (fun _ (_ : Unit) => false) TAut ((Sum.inr (Sum.inr (Sum.inr (Sum.inr ())))) : gC.State) ()
                = some ((), ((Sum.inr (Sum.inl ())) : gC.State)) := by rfl
            rw [hred] at hst
            have hs := congrArg Prod.snd (Option.some.inj hst)
            subst hs
        ...
        | true =>
            rw [hb] at hst
            have hred : autStep (fun _ (_ : Unit) => true) TAut ((Sum.inr (Sum.inr (Sum.inr (Sum.inr ())))) : gC.State) ()
                = none := by rfl
            rw [hred] at hst
            exact absurd hst (by simp)
  | Sum.inr none =>
  ...
  | Sum.inr (some (Sum.inl (Sum.inl (Sum.inl (Sum.inr ()))))) =>
      first | simp only [tmap] | skip
      refine ⟨fun a => ?_, fun a q s' hst => ?_, fun a q s2' hst => ?_⟩
      · show bval W (SUM.hlt (Sum.inr (some (Sum.inl (Sum.inl (Sum.inl (Sum.inr ()))))))) a = bval W (TAut.hlt (Sum.inr (Sum.inl ()))) a
        rw [bval_hlt_unit SUM, bval_hlt_unit TAut]
        cases hb : W () a <;> rfl
      · rw [autStep_unit] at hst
        cases hb : W () a with
  ...
  | Sum.inr (some (Sum.inl (Sum.inl (Sum.inr (Sum.inr ()))))) =>
      first | simp only [tmap] | skip
      refine ⟨fun a => ?_, fun a q s' hst => ?_, fun a q s2' hst => ?_⟩
      · show bval W (SUM.hlt (Sum.inr (some (Sum.inl (Sum.inl (Sum.inr (Sum.inr ()))))))) a = bval W (TAut.hlt (Sum.inr (Sum.inl ()))) a
        rw [bval_hlt_unit SUM, bval_hlt_unit TAut]
        cases hb : W () a <;> rfl
      · rw [autStep_unit] at hst
        cases hb : W () a with
  ...
  | Sum.inr (some (Sum.inl (Sum.inr (Sum.inl (Sum.inl (Sum.inr ())))))) =>
      first | simp only [tmap] | skip
      refine ⟨fun a => ?_, fun a q s' hst => ?_, fun a q s2' hst => ?_⟩
      · show bval W (SUM.hlt (Sum.inr (some (Sum.inl (Sum.inr (Sum.inl (Sum.inl (Sum.inr ())))))))) a = bval W (TAut.hlt (Sum.inr (Sum.inr (Sum.inl (Sum.inr ()))))) a
        rw [bval_hlt_unit SUM, bval_hlt_unit TAut]
        cases hb : W () a <;> rfl
      · rw [autStep_unit] at hst
        cases hb : W () a with
  ...
  | Sum.inr (some (Sum.inl (Sum.inr (Sum.inl (Sum.inr (Sum.inr ())))))) =>
      first | simp only [tmap] | skip
      refine ⟨fun a => ?_, fun a q s' hst => ?_, fun a q s2' hst => ?_⟩
      · show bval W (SUM.hlt (Sum.inr (some (Sum.inl (Sum.inr (Sum.inl (Sum.inr (Sum.inr ())))))))) a = bval W (TAut.hlt (Sum.inr (Sum.inr (Sum.inr (Sum.inr ()))))) a
        rw [bval_hlt_unit SUM, bval_hlt_unit TAut]
        cases hb : W () a <;> rfl
      · rw [autStep_unit] at hst
        cases hb : W () a with
...
def tquot : UniformBehavioralGAutQuotient SUM TAut where
  ...
  onto_states := by
    ...
    | Sum.inr (Sum.inl ()), _ => exact ⟨(Sum.inl (some (Sum.inl (Sum.inl (Sum.inl (Sum.inr ())))))), (List.mem_append.mpr (Or.inl (List.mem_map_of_mem (List.Mem.tail _ (List.mem_map_of_mem (GkatTotalization.thompson_states_complete eP (Sum.inl (Sum.inl (Sum.inl (Sum.inr ())))))))))), rfl⟩
    | Sum.inr (Sum.inr (Sum.inl (Sum.inr ()))), _ => exact ⟨(Sum.inl (some (Sum.inl (Sum.inr (Sum.inl (Sum.inr ())))))), (List.mem_append.mpr (Or.inl (List.mem_map_of_mem (List.Mem.tail _ (List.mem_map_of_mem (GkatTotalization.thompson_states_complete eP (Sum.inl (Sum.inr (Sum.inl (Sum.inr ())))))))))), rfl⟩
    | Sum.inr (Sum.inr (Sum.inr (Sum.inr ()))), _ => exact ⟨(Sum.inl (some (Sum.inl (Sum.inr (Sum.inr (Sum.inr ())))))), (List.mem_append.mpr (Or.inl (List.mem_map_of_mem (List.Mem.tail _ (List.mem_map_of_mem (GkatTotalization.thompson_states_complete eP (Sum.inl (Sum.inr (Sum.inr (Sum.inr ())))))))))), rfl⟩

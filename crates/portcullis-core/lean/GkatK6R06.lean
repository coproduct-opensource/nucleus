...
/-! # GkatK6R06: emitted instance certificate (machine-generated; see emit_cert.py) -/
...
theorem ringE0 : EquivBA sol0 (.ite bT (.seq pA sol1) (.test (BExp.not bT))) :=
  EquivBA.trans (EquivBA.base (salomaa_solution_exists bT BODY (.test (BExp.not bT))))
    (EquivBA.ite_c (EquivBA.trans (EquivBA.base (Equiv.s1 pA (.seq pA (.seq (.wh (BExp.not bT) pA) (.seq pA (.ite (BExp.not bT) (.test (BExp.not bT)) pA)))) sol0))
      (EquivBA.seq_c (EquivBA.base (Equiv.refl _)) (EquivBA.trans (EquivBA.base (Equiv.s1 pA (.seq (.wh (BExp.not bT) pA) (.seq pA (.ite (BExp.not bT) (.test (BExp.not bT)) pA))) sol0))
      (EquivBA.seq_c (EquivBA.base (Equiv.refl _)) (EquivBA.trans (EquivBA.base (Equiv.s1 (.wh (BExp.not bT) pA) (.seq pA (.ite (BExp.not bT) (.test (BExp.not bT)) pA)) sol0))

...
/-! # GkatK6R09: emitted instance certificate (machine-generated; see emit_cert.py) -/
...
def eP : Exp Act Tst := (Exp.seq (Exp.ite bT (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)) (Exp.test (BExp.not bT))) (Exp.wh (BExp.not bT) (Exp.seq (Exp.seq pA (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA)) (Exp.ite bT (Exp.test bT) pA))))
def fP : Exp Act Tst := (Exp.seq (Exp.seq (Exp.ite bT (Exp.test bT) pA) (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA)) (Exp.wh (BExp.not bT) (Exp.seq pA (Exp.ite (BExp.not bT) (Exp.seq pA (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA)) (Exp.test bT)))))

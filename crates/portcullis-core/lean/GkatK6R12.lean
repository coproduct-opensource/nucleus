...
/-! # GkatK6R12: emitted instance certificate (machine-generated; see emit_cert.py) -/
...
def eP : Exp Act Tst := (Exp.seq (Exp.seq (Exp.ite bT (Exp.test bT) pA) (Exp.wh bT pA)) (Exp.wh (BExp.not bT) (Exp.seq pA (Exp.ite bT (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.wh (BExp.not bT) pA)))))
def fP : Exp Act Tst := (Exp.seq (Exp.seq pA (Exp.wh bT pA)) (Exp.wh (BExp.not bT) (Exp.seq pA (Exp.ite bT (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.wh (BExp.not bT) pA)))))

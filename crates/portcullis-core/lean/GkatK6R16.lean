...
/-! # GkatK6R16: emitted instance certificate (machine-generated; see emit_cert.py) -/
...
def eP : Exp Act Tst := (Exp.seq (Exp.ite (BExp.not bT) (Exp.seq (Exp.ite bT (Exp.test BExp.zero) pA) (Exp.ite (BExp.not bT) (Exp.test (BExp.not bT)) pA)) (Exp.test bT)) (Exp.wh bT (Exp.seq (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)) (Exp.ite (BExp.not bT) (Exp.test (BExp.not bT)) pA))))
def fP : Exp Act Tst := (Exp.seq (Exp.seq (Exp.ite (BExp.not bT) (Exp.test (BExp.not bT)) pA) (Exp.ite bT (Exp.test bT) pA)) (Exp.wh bT (Exp.seq pA (Exp.ite bT (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)) (Exp.test (BExp.not bT))))))
...
theorem ringE3 : EquivBA sol3 (.ite (BExp.not bT) (.seq pA sol1) (.ite bT (.seq pA sol2) (.test BExp.zero))) :=
  (EquivBA.trans (EquivBA.symm (EquivBA.base (Equiv.u5 bT pA (.seq pA (.ite (BExp.not bT) (.test (BExp.not bT)) pA)) sol2)))
    ...
    (EquivBA.trans (EquivBA.base (Equiv.u2 bT (.seq pA sol2) (.seq pA sol1)))

...
/-! # GkatK6R20: emitted instance certificate (machine-generated; see emit_cert.py) -/
...
def eP : Exp Act Tst := (Exp.wh bT (Exp.seq pA (Exp.ite bT (Exp.seq (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) pA) (Exp.seq (Exp.wh (BExp.not bT) pA) (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA))) (Exp.test (BExp.not bT)))))
def fP : Exp Act Tst := (Exp.wh bT (Exp.seq pA (Exp.ite bT (Exp.seq (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.ite (BExp.not bT) (Exp.test (BExp.not bT)) pA)) (Exp.seq (Exp.wh (BExp.not bT) pA) (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA))) (Exp.test (BExp.not bT)))))
...
def sol3 : Exp Act Tst := (.seq (.wh (BExp.not bT) pA) (.seq pA sol0))
...
theorem ringE3 : EquivBA sol3 (.ite (BExp.not bT) (.seq pA sol3) (.ite bT (.seq pA sol0) (.test BExp.zero))) :=
  EquivBA.trans (EquivBA.base (salomaa_solution_exists (BExp.not bT) pA (.seq pA sol0)))

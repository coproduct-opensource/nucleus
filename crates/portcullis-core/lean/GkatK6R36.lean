...
/-! # GkatK6R36: emitted instance certificate (machine-generated; see emit_cert.py) -/
...
def eP : Exp Act Tst := (Exp.seq (Exp.ite bT (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)) (Exp.test (BExp.not bT))) (Exp.wh (BExp.not bT) (Exp.seq (Exp.seq (Exp.ite bT (Exp.test BExp.zero) pA) (Exp.test (BExp.not bT))) (Exp.seq (Exp.ite bT (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)))))
def fP : Exp Act Tst := (Exp.seq (Exp.seq (Exp.ite (BExp.not bT) (Exp.seq pA (Exp.test (BExp.not bT))) (Exp.test bT)) pA) (Exp.wh (BExp.not bT) (Exp.seq pA (Exp.ite (BExp.not bT) (Exp.seq pA (Exp.ite bT (Exp.test BExp.zero) pA)) (Exp.test bT)))))
...
def sol3 : Exp Act Tst := (.seq (.ite (BExp.not bT) pA (.test BExp.zero)) sol1)
...
theorem ringE3 : EquivBA sol3 (.ite (BExp.not bT) (.seq pA sol1) (.test BExp.zero)) :=
  EquivBA.trans (EquivBA.symm (EquivBA.base (Equiv.u5 (BExp.not bT) pA (.test BExp.zero) sol1)))

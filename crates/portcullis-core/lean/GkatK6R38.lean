...
/-! # GkatK6R38: emitted instance certificate (machine-generated; see emit_cert.py) -/
...
def eP : Exp Act Tst := (Exp.seq (Exp.seq (Exp.ite (BExp.not bT) (Exp.test (BExp.not bT)) pA) (Exp.wh (BExp.not bT) pA)) (Exp.wh bT (Exp.seq pA (Exp.ite bT (Exp.seq pA (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA)) (Exp.test (BExp.not bT))))))
def fP : Exp Act Tst := (Exp.seq (Exp.seq pA (Exp.wh (BExp.not bT) pA)) (Exp.wh bT (Exp.seq pA (Exp.ite bT (Exp.seq pA (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA)) (Exp.test (BExp.not bT))))))
...
def BODY : Exp Act Tst := (.seq pA (.seq (.ite bT pA (.test BExp.zero)) (.ite (BExp.not bT) (.test (BExp.not bT)) pA)))
...
def sol3 : Exp Act Tst := (.seq (.ite bT pA (.test BExp.zero)) sol4)
...
theorem ringE2 : EquivBA sol2 (.ite bT (.seq pA sol3) (.test (BExp.not bT))) :=
  EquivBA.trans (EquivBA.base (salomaa_solution_exists bT BODY (.test (BExp.not bT))))
    (EquivBA.ite_c (EquivBA.trans (EquivBA.base (Equiv.s1 pA (.seq (.ite bT pA (.test BExp.zero)) (.ite (BExp.not bT) (.test (BExp.not bT)) pA)) sol2))
      (EquivBA.seq_c (EquivBA.base (Equiv.refl _)) (EquivBA.base (Equiv.s1 (.ite bT pA (.test BExp.zero)) (.ite (BExp.not bT) (.test (BExp.not bT)) pA) sol2)))) (EquivBA.base (Equiv.refl _)))
...
theorem ringE3 : EquivBA sol3 (.ite bT (.seq pA sol4) (.test BExp.zero)) :=
  EquivBA.trans (EquivBA.symm (EquivBA.base (Equiv.u5 bT pA (.test BExp.zero) sol4)))
    (EquivBA.ite_c (EquivBA.base (Equiv.refl _)) (EquivBA.base (Equiv.s2 sol4)))

...
/-! # GkatK6R40: emitted instance certificate (machine-generated; see emit_cert.py) -/
...
def eP : Exp Act Tst := (Exp.seq (Exp.seq (Exp.ite (BExp.not bT) (Exp.test (BExp.not bT)) pA) (Exp.wh (BExp.not bT) pA)) (Exp.wh bT (Exp.seq pA (Exp.ite bT (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)) (Exp.test (BExp.not bT))))))
def fP : Exp Act Tst := (Exp.seq (Exp.seq pA (Exp.wh (BExp.not bT) pA)) (Exp.wh bT (Exp.seq pA (Exp.ite bT (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)) (Exp.test (BExp.not bT))))))
...
def BODY : Exp Act Tst := (.seq pA (.ite bT pA (.seq pA (.ite (BExp.not bT) (.test (BExp.not bT)) pA))))
...
def sol3 : Exp Act Tst := (.seq (.ite bT pA (.seq pA (.ite (BExp.not bT) (.test (BExp.not bT)) pA))) sol2)
...
theorem ringE2 : EquivBA sol2 (.ite bT (.seq pA sol3) (.test (BExp.not bT))) :=
  EquivBA.trans (EquivBA.base (salomaa_solution_exists bT BODY (.test (BExp.not bT))))
    (EquivBA.ite_c (EquivBA.base (Equiv.s1 pA (.ite bT pA (.seq pA (.ite (BExp.not bT) (.test (BExp.not bT)) pA))) sol2)) (EquivBA.base (Equiv.refl _)))
...
theorem ringE3 : EquivBA sol3 (.ite (BExp.not bT) (.seq pA sol4) (.ite bT (.seq pA sol2) (.test BExp.zero))) :=
  (EquivBA.trans (EquivBA.symm (EquivBA.base (Equiv.u5 bT pA (.seq pA (.ite (BExp.not bT) (.test (BExp.not bT)) pA)) sol2)))
    (EquivBA.trans (EquivBA.ite_c (EquivBA.base (Equiv.refl _)) (EquivBA.base (Equiv.s1 pA (.ite (BExp.not bT) (.test (BExp.not bT)) pA) sol2)))

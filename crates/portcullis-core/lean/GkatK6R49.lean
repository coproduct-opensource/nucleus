...
/-! # GkatK6R49: emitted instance certificate (machine-generated; see emit_cert.py) -/
...
def eP : Exp Act Tst := (Exp.wh (BExp.not bT) (Exp.seq pA (Exp.ite (BExp.not bT) (Exp.seq (Exp.seq (Exp.ite bT (Exp.test BExp.zero) pA) pA) (Exp.seq (Exp.wh bT pA) (Exp.ite bT (Exp.test BExp.zero) pA))) (Exp.test bT))))
def fP : Exp Act Tst := (Exp.wh (BExp.not bT) (Exp.seq pA (Exp.ite (BExp.not bT) (Exp.seq (Exp.seq (Exp.ite bT (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)) (Exp.seq (Exp.wh bT pA) (Exp.ite bT (Exp.test BExp.zero) pA))) (Exp.test bT))))
...
/-! ## Ring solutions (machine-generated; see emit_ring.py).
    SCC [0, 1, 2, 3] header=1 exit=bT; the walk plan and every proof
...
def sol0 : Exp Act Tst := (.seq (.ite bT (.test bT) pA) sol1)

...
/-! # GkatK6R54: emitted instance certificate (machine-generated; see emit_cert.py) -/
...
def eP : Exp Act Tst := (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.wh bT (Exp.seq pA (Exp.ite bT (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.ite (BExp.not bT) (Exp.test (BExp.not bT)) pA)) (Exp.wh (BExp.not bT) pA)))))
def fP : Exp Act Tst := (Exp.ite bT (Exp.wh bT (Exp.seq pA (Exp.ite bT (Exp.seq pA (Exp.seq (Exp.wh (BExp.not bT) (Exp.seq (Exp.wh (BExp.not bT) pA) (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA))) pA)) (Exp.test (BExp.not bT))))) (Exp.test BExp.zero))
...
def sol2 : Exp Act Tst := (.seq (.wh (BExp.not bT) (.seq pA (.seq (.wh (BExp.not bT) pA) pA))) (.seq pA sol3))
def sol4 : Exp Act Tst := (.seq (.wh (BExp.not bT) pA) (.seq pA sol2))
...
theorem ringE2 : EquivBA sol2 (.ite (BExp.not bT) (.seq pA sol4) (.ite bT (.seq pA sol3) (.test BExp.zero))) :=
  (EquivBA.trans (EquivBA.base (salomaa_solution_exists (BExp.not bT) (.seq pA (.seq (.wh (BExp.not bT) pA) pA)) (.seq pA sol3)))
...
theorem ringE4 : EquivBA sol4 (.ite (BExp.not bT) (.seq pA sol4) (.ite bT (.seq pA sol2) (.test BExp.zero))) :=

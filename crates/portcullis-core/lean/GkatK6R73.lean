...
/-! # GkatK6R73: emitted instance certificate (machine-generated; see emit_cert.py) -/
...
def eP : Exp Act Tst := (Exp.seq (Exp.seq (Exp.ite bT (Exp.test bT) pA) (Exp.wh bT pA)) (Exp.wh (BExp.not bT) (Exp.seq pA (Exp.ite (BExp.not bT) (Exp.seq pA (Exp.ite bT (Exp.seq pA (Exp.test bT)) (Exp.test (BExp.not bT)))) (Exp.test bT)))))
def fP : Exp Act Tst := (Exp.seq (Exp.seq pA (Exp.wh bT pA)) (Exp.wh (BExp.not bT) (Exp.seq pA (Exp.ite (BExp.not bT) (Exp.seq pA (Exp.ite bT (Exp.seq pA (Exp.test bT)) (Exp.test (BExp.not bT)))) (Exp.test bT)))))
...
/-! ## Ring solutions (machine-generated; see emit_ring.py).
    SCC [2, 3] header=2 exit=bT; the walk plan and every proof
...
def sol3 : Exp Act Tst := (.seq (.ite bT (.seq pA sol4) pA) sol2)
...
theorem ringE2 : EquivBA sol2 (.ite (BExp.not bT) (.seq pA sol3) (.test bT)) :=
  EquivBA.trans (EquivBA.base (salomaa_solution_exists (BExp.not bT) BODY (.test bT)))
    (EquivBA.ite_c (EquivBA.base (Equiv.s1 pA (.ite bT (.seq pA sol4) pA) sol2)) (EquivBA.base (Equiv.refl _)))

theorem ringE3 : EquivBA sol3 (.ite (BExp.not bT) (.seq pA sol2) (.ite bT (.seq pA sol4) (.test BExp.zero))) :=
  (EquivBA.trans (EquivBA.symm (EquivBA.base (Equiv.u5 bT (.seq pA sol4) pA sol2)))
    ...
    (EquivBA.trans (EquivBA.base (Equiv.u2 bT (.seq pA sol4) (.seq pA sol2)))

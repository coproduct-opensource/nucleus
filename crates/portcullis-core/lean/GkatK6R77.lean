...
/-! # GkatK6R77: emitted instance certificate (machine-generated; see emit_cert.py) -/
...
def eP : Exp Act Tst := (Exp.seq (Exp.seq (Exp.ite (BExp.not bT) (Exp.test (BExp.not bT)) pA) (Exp.wh (BExp.not bT) pA)) (Exp.wh bT (Exp.seq (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)) (Exp.ite (BExp.not bT) (Exp.test (BExp.not bT)) pA))))
def fP : Exp Act Tst := (Exp.seq (Exp.seq pA (Exp.wh (BExp.not bT) pA)) (Exp.wh bT (Exp.seq (Exp.seq (Exp.ite (BExp.not bT) (Exp.test BExp.zero) pA) (Exp.ite bT (Exp.test bT) pA)) (Exp.ite (BExp.not bT) (Exp.test (BExp.not bT)) pA))))
...
def sol2 : Exp Act Tst := (.seq (.ite bT pA (.seq pA (.ite (BExp.not bT) (.test (BExp.not bT)) pA))) sol4)
...
theorem ringE4 : EquivBA sol4 (.ite bT (.seq pA sol2) (.test (BExp.not bT))) :=
  EquivBA.trans (EquivBA.base (salomaa_solution_exists bT BODY (.test (BExp.not bT))))
    (EquivBA.ite_c (EquivBA.base (Equiv.s1 pA (.ite bT pA (.seq pA (.ite (BExp.not bT) (.test (BExp.not bT)) pA))) sol4)) (EquivBA.base (Equiv.refl _)))
...
theorem ringE2 : EquivBA sol2 (.ite (BExp.not bT) (.seq pA sol3) (.ite bT (.seq pA sol4) (.test BExp.zero))) :=
  (EquivBA.trans (EquivBA.symm (EquivBA.base (Equiv.u5 bT pA (.seq pA (.ite (BExp.not bT) (.test (BExp.not bT)) pA)) sol4)))
    (EquivBA.trans (EquivBA.ite_c (EquivBA.base (Equiv.refl _)) (EquivBA.base (Equiv.s1 pA (.ite (BExp.not bT) (.test (BExp.not bT)) pA) sol4)))

...
//! under the line ratchet's sweep ceiling. Adding `program_checksum` took the
//! module to 2556 lines against a 2500 default. Same remedy `certificate_tests.rs`
//! already uses in this crate, and preferable to declaring a new ceiling — that

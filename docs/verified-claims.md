...
- **Kani BMC** bounded model checking of Rust implementations (119 harnesses repo-wide: portcullis 69, portcullis-core 26, ck-kernel 17, nucleus-ifc-kernel 6, nucleus-econ-kernels 1)

...
The North Star, its ledgers, and the roadmap live in
**[`docs/north-star.md`](docs/north-star.md)**. The paragraph below is the
one-line pitch this file used to be; it is a pitch, not a claim, and nothing
in CI checks it.

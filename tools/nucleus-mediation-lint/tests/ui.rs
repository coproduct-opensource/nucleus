// UI test harness via dylint_testing, mirroring the sibling `nucleus-guarantee-lint`.
//
...
// processes compiletest spawns. The sibling `nucleus-guarantee-lint` fails identically
